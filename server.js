...
// ******* TO DO ********
// add users that are currently on channels to server list
// ******* TO DO ********

// ******* TO DO ********
// don't allow same name servers
// ******* TO DO ********

// ******* TO DO ********
// to destroy a room within a delay place an condition
// when there are no more sockets for whom the currentServer isn't that room
// make an array that follows the users who are in servers
// ******* TO DO ********
const fs = require("fs");
